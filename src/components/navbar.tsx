  ...
  const Components: components[] = [
      ...
      child: [
        {
          ...
          description:
            "Provide general health care, preventive care, and manage common illnesses.",
        ...
        },
        {
          ...
          name: "Others",
          description:
            "Include doctors like anesthesiologists, radiologists, pathologists, and geriatricians with specialized roles.",
        },
        {
          name: "All Doctors",
          description:
            "Explore all categories of doctors and specialists in one place.",
          href: consultHref,
        },
      ],
    },

    {
      ...
      child: [
        ...
        },
        {
          ...
          description:
            "Past illnesses, surgeries, allergies, and ongoing health conditions.",
          href: `${patientsHref}/medical-history`,
        },
        {
          name: "Lab Reports",
          description:
            "Blood tests, X-rays, scans, and other diagnostic reports.",
        ...
        },
        {
          name: "Appointments",
          description:
            "Scheduled, upcoming, and past doctor visits or telemedicine sessions.",
          href: `${patientsHref}/appointments`,
        },
        {
          name: "All Records",
          description:
            "Access all patient information and medical records in one place.",
          href: patientsHref,
        },
      ],
    },
    {
      ...
      child: [
        {
          name: "Antibiotics",
          description: "Treat bacterial infections and prevent their spread.",
          href: `${medicineHref}/antibiotics`,
        },
        {
          name: "Painkillers",
          description: "Relieve mild to severe pain and inflammation.",
          href: `${medicineHref}/painkillers`,
        },
        {
          name: "Vitamins & Supplements",
          description: "Support nutrition, immunity, and overall health.",
          href: `${medicineHref}/vitamins`,
        },
        {
          name: "Chronic Disease Medications",
          description:
            "Manage conditions like diabetes, hypertension, and asthma.",
          href: `${medicineHref}/chronic`,
        },
        {
          name: "Cold & Flu Remedies",
          description:
            "Relieve symptoms of colds, flu, and respiratory issues.",
          href: `${medicineHref}/cold-flu`,
        },
        {
          name: "Allergy Medications",
          description: "Control allergies, hay fever, and asthma triggers.",
          href: `${medicineHref}/allergy`,
        },
        {
          name: "Digestive Health",
          description: "Support gut health, treat acidity, and indigestion.",
          href: `${medicineHref}/digestive`,
        },
        {
          name: "Skin Treatments",
          description:
            "Creams, ointments, and medications for skin conditions.",
          href: `${medicineHref}/skin`,
        },
  ...
  return (
    <div className={cn(`inset-x-0  max-w-2xl mx-auto z-50`, className)}>
      <Menu
        setActive={setActive}
        className={cn(
          "dark:bg-gray-900 shadow-xl dark:shadow-white/10 inline-flex justify-center py-2 px-3 "
        )}
      >
        <div className="inline-flex gap-5">
          {Components.map((item: components, index) => (
            <MenuItem
              ...
              setActive={setActive}
              active={active}
              className={`py-2  hover:bg-gray-200 dark:hover:bg-gray-500/30  rounded-2xl px-3`}
              item={item.title}
            >
              <ul className="grid md:max-w-xl md:grid-cols-2">
                {item.child.map(
                  (link: components["child"][number], index, item) => {
                    return (
                      <li
                        key={link.name}
                        className=" col-span-1 dark:hover:bg-gray-500/30 hover:bg-gray-200 transition rounded-lg p-1.5 px-2 "
                      >
                        {item.length > 6 ? (
...
const navItems = [
  ...
  { name: "Medicine Store", href: "/medicines", icon: Pill },
  { name: "Medical Records", href: "/records", icon: Hospital },
];

const moreItems = [
  { name: "Video Consultation", href: "/consult", icon: Bot },
  { name: "Health Awareness", href: "/awareness", icon: Shield },
];
  ...
  return (
    <div className="w-full md:flex rounded-b-md hidden shadow-[0_0_10px] dark:shadow-white/30  flex-wrap justify-center gap-y-4">
      <div className="flex w-full justify-between p-2 py-1.5 lg:p-4 shadow">
        ...
        <div className="hidden md:flex items-center gap-1 bg-muted/40 px-2 py-1 rounded-full">
          {navItems.map((item) => {
            ...
            <DropdownMenuTrigger asChild>
              <button
                className="flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium
                   text-foreground hover:bg-primary/10 transition-all"
              >
                <span>⋯</span>
                <span>More</span>
        ...
        <div className="flex sm:gap-x-4 items-center">
          <button
            ...
            className="cursor-pointer border-black/20 dark:border-white/20 border-2
            rounded-2xl p-1"
          >
            {theme === "dark" ? (
